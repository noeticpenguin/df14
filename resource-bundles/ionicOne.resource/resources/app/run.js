angular.module('ionicOne')
	.run(['$http', '$rootScope', '$state', '$stateParams', '$log', '$ionicPlatform', 'ngForceConfig',
		function($http, $rootScope, $state, $stateParams, $log, $ionicPlatform, ngForceConfig) {

			$log.log('ngForceConfig is: ', ngForceConfig);

			// Ionic Specific Runtime Configkey: "value", 
