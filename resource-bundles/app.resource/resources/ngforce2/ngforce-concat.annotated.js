 ...
 */
angular.module('ngForce').factory('sfrfile', ['$q', '$rootScope', '$log', 'Restangular', 'MultipartRequest', 'RequestPart', function($q, $rootScope, $log, Restangular, MultipartRequest, RequestPart) {
